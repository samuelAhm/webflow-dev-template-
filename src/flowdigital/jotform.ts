...
document.addEventListener('DOMContentLoaded', () => {
  ...
  //logo section
  createScrollAnimation('jotfrom--sect', 'jotfrom-item', {});
  //businees section
  ...
  //scroll section
  createScrollAnimation('scroll--sect', 'scroll-item', {});
...
function horizontal_Scroll() {
  ...
  // //get the width
  // const containerWidth = scrollDivs_container?.getBoundingClientRect().width;
  const numSlides = scrollDivs.length - 1;
  ///horizonal scroll
